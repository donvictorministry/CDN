    ...
    const StorageManager = {
        ...
        init: function () {
            return new Promise((resolve, reject) => {
                ...
                request.onupgradeneeded = function (event) {
                    ...
                    if (!db.objectStoreNames.contains(CONFIG.SHOPE_NAME)) {
                        db.createObjectStore(CONFIG.SHOPE_NAME, { keyPath: 'id', autoIncrement: true });
                    }
                };
        ...
        enqueue: function (payload) {
            return new Promise((resolve, reject) => {
                ...
                const transaction = this.db.transaction([CONFIG.SHOPE_NAME], 'readwrite');
                const store = transaction.objectStore(CONFIG.SHOPE_NAME);
        ...
        getBatch: function () {
            return new Promise((resolve, reject) => {
                ...
                const transaction = this.db.transaction([CONFIG.SHOPE_NAME], 'readonly');
                const store = transaction.objectStore(CONFIG.SHOPE_NAME);
